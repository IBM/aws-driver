...
class VCECloudFormation(CloudFormation):
    ...
    def create(self, resource_id, lifecycle_name, driver_files, system_properties, resource_properties, request_properties, associated_topology, aws_location):
        logger.info(f'invoking creation of VCE VM for request :: {resource_id} and resource_prop as :: {resource_properties}')
        ...
        if stack_id is None:
            ...
            cf_template = self.render_template(system_properties, resource_properties, request_properties, 'cloudformation_vce.yaml')
        ...
        logger.info(f'completed creation of vce for request :: {resource_id} and resource_prop as :: {resource_properties}')
    ...
    def remove(self, resource_id, lifecycle_name, driver_files, system_properties, resource_properties, request_properties, associated_topology, aws_location):
        logger.info(f'invoking removal of vce for request :: {resource_id} and resource_prop as :: {resource_properties}')
