...
class TestDriver(unittest.TestCase):
    ...
    def test_driver_1(self):
        dl = {
            'name': "aws1",
            'properties': {
                'aws_access_key_id': 'AKIAYAP65K3CB74WMN4L',
                'aws_secret_access_key': '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'
            }
        }
    ...
    def __deployment_location(self):
        ...
        return {
            NAME: "ap-south-1",
            PROPERTIES: {
                AWS_ACCESS_KEY_ID: "AKIA2Z3UQKJ5L4HNZFUR",
                AWS_SECRET_ACCESS_KEY: "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"
            }
        }
