...
DIST_DIR = 'dist'
WHL_FORMAT = 'awsdriver-{version}-py3-none-any.whl'

DOCS_FORMAT = 'aws-driver-{version}-docs'
DOCS_DIR = 'docs'

DOCKER_WHLS_DIR = 'whls'
DOCKER_PATH = 'docker'
DOCKER_IMG_NAME = 'aws-driver'
DOCKER_REGISTRY = 'icr.io/cp4na-drivers'

HELM_CHART_PATH = os.path.join('helm', 'aws-driver')
HELM_CHART_NAME = 'aws-driver'
HELM_CHART_NAME_FORMAT = 'aws-driver-{0}.tgz'
