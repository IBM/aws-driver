...
class SubnetCloudFormation(CloudFormation):
    ...
    def create(self, resource_id, lifecycle_name, driver_files, system_properties, resource_properties, request_properties, associated_topology, aws_location):
        logger.info(f'invoking creation of subnet stack for resourece :: {resource_id} and resource_prop as :: {resource_properties}')
        ...
        if stack_id is None:
            ...
            cf_template = self.render_template(system_properties, resource_properties, request_properties, 'cloudformation_subnet.yaml')
        ...
        logger.info(f'completed creation of subnet stack for resourece :: {resource_id} and resource_prop as :: {resource_properties}')
